...
namespace IPGeolocation.Test.Model
{
    ...
    public class TimezoneLocationTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" TimezoneLocation
            //Assert.IsType<TimezoneLocation>(instance);
        }
