...
[assembly: InternalsVisibleTo("IPGeolocation.Test")]
...
namespace IPGeolocation.Client
{
    ...
    public static class ClientUtils
    {
        ...
        public readonly struct ApiKeyHeader
        {
            public string Name { get; }
            public Location Location { get; }

            public ApiKeyHeader(string name, Location location = Location.Query)
            {
                Name = name;
                Location = location;
            }
        ...
        /// </summary>
        public const string BASE_ADDRESS = "https://api.ipgeolocation.io/v2";
        ...
        /// The host of the API
        /// </summary>
        public const string HOST = "api.ipgeolocation.io";
