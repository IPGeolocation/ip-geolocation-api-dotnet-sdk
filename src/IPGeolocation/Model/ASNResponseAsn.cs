...
namespace IPGeolocation.Model
{
    ...
    /// ASNResponseAsn
    /// </summary>
    public partial class ASNResponseAsn : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ASNResponseAsn" /> class.
        /// </summary>
        ...
        /// <param name="upstreams">It will only be included in the response, if you set include&#x3D;upstreams in the request</param>
        /// <param name="downstreams">It will only be included in the response, if you set include&#x3D;downstreams in the request</param>
        /// <param name="peers">It will only be included in the response, if you set include&#x3D;peers in the request</param>
        /// <param name="whoisResponse">It will only be included in the response, if you set include&#x3D;whois_response in the request</param>
        [JsonConstructor]
        public ASNResponseAsn(Option<string?> asNumber = default, Option<string?> organization = default, Option<string?> country = default, Option<string?> asnName = default, Option<string?> type = default, Option<string?> domain = default, Option<string?> dateAllocated = default, Option<string?> allocationStatus = default, Option<string?> numOfIpv4Routes = default, Option<string?> numOfIpv6Routes = default, Option<string?> rir = default, Option<List<string>?> routes = default, Option<List<ASNConnection>?> upstreams = default, Option<List<ASNConnection>?> downstreams = default, Option<List<ASNConnection>?> peers = default, Option<string?> whoisResponse = default)
        {
        ...
        /// </summary>
        /// <value>It will only be included in the response, if you set include&#x3D;upstreams in the request</value>
        ...
        /// </summary>
        /// <value>It will only be included in the response, if you set include&#x3D;downstreams in the request</value>
        ...
        /// </summary>
        /// <value>It will only be included in the response, if you set include&#x3D;peers in the request</value>
        ...
        /// </summary>
        /// <value>It will only be included in the response, if you set include&#x3D;whois_response in the request</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ASNResponseAsn {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ASNResponseAsn" />
    /// </summary>
    public class ASNResponseAsnJsonConverter : JsonConverter<ASNResponseAsn>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="ASNResponseAsn" />
        /// </summary>
        ...
        public override ASNResponseAsn Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (asNumber.IsSet && asNumber.Value == null)
                throw new ArgumentNullException(nameof(asNumber), "Property is not nullable for class ASNResponseAsn.");

            if (organization.IsSet && organization.Value == null)
                throw new ArgumentNullException(nameof(organization), "Property is not nullable for class ASNResponseAsn.");

            if (country.IsSet && country.Value == null)
                throw new ArgumentNullException(nameof(country), "Property is not nullable for class ASNResponseAsn.");

            if (asnName.IsSet && asnName.Value == null)
                throw new ArgumentNullException(nameof(asnName), "Property is not nullable for class ASNResponseAsn.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class ASNResponseAsn.");

            if (domain.IsSet && domain.Value == null)
                throw new ArgumentNullException(nameof(domain), "Property is not nullable for class ASNResponseAsn.");

            if (dateAllocated.IsSet && dateAllocated.Value == null)
                throw new ArgumentNullException(nameof(dateAllocated), "Property is not nullable for class ASNResponseAsn.");

            if (allocationStatus.IsSet && allocationStatus.Value == null)
                throw new ArgumentNullException(nameof(allocationStatus), "Property is not nullable for class ASNResponseAsn.");

            if (numOfIpv4Routes.IsSet && numOfIpv4Routes.Value == null)
                throw new ArgumentNullException(nameof(numOfIpv4Routes), "Property is not nullable for class ASNResponseAsn.");

            if (numOfIpv6Routes.IsSet && numOfIpv6Routes.Value == null)
                throw new ArgumentNullException(nameof(numOfIpv6Routes), "Property is not nullable for class ASNResponseAsn.");

            if (rir.IsSet && rir.Value == null)
                throw new ArgumentNullException(nameof(rir), "Property is not nullable for class ASNResponseAsn.");

            if (routes.IsSet && routes.Value == null)
                throw new ArgumentNullException(nameof(routes), "Property is not nullable for class ASNResponseAsn.");

            if (upstreams.IsSet && upstreams.Value == null)
                throw new ArgumentNullException(nameof(upstreams), "Property is not nullable for class ASNResponseAsn.");

            if (downstreams.IsSet && downstreams.Value == null)
                throw new ArgumentNullException(nameof(downstreams), "Property is not nullable for class ASNResponseAsn.");

            if (peers.IsSet && peers.Value == null)
                throw new ArgumentNullException(nameof(peers), "Property is not nullable for class ASNResponseAsn.");

            if (whoisResponse.IsSet && whoisResponse.Value == null)
                throw new ArgumentNullException(nameof(whoisResponse), "Property is not nullable for class ASNResponseAsn.");

            return new ASNResponseAsn(asNumber, organization, country, asnName, type, domain, dateAllocated, allocationStatus, numOfIpv4Routes, numOfIpv6Routes, rir, routes, upstreams, downstreams, peers, whoisResponse);
        }

        /// <summary>
        /// Serializes a <see cref="ASNResponseAsn" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="aSNResponseAsn"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ASNResponseAsn aSNResponseAsn, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, aSNResponseAsn, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ASNResponseAsn" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="aSNResponseAsn"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ASNResponseAsn aSNResponseAsn, JsonSerializerOptions jsonSerializerOptions)
        {
            if (aSNResponseAsn.AsNumberOption.IsSet && aSNResponseAsn.AsNumber == null)
                throw new ArgumentNullException(nameof(aSNResponseAsn.AsNumber), "Property is required for class ASNResponseAsn.");

            if (aSNResponseAsn.OrganizationOption.IsSet && aSNResponseAsn.Organization == null)
                throw new ArgumentNullException(nameof(aSNResponseAsn.Organization), "Property is required for class ASNResponseAsn.");

            if (aSNResponseAsn.CountryOption.IsSet && aSNResponseAsn.Country == null)
                throw new ArgumentNullException(nameof(aSNResponseAsn.Country), "Property is required for class ASNResponseAsn.");

            if (aSNResponseAsn.AsnNameOption.IsSet && aSNResponseAsn.AsnName == null)
                throw new ArgumentNullException(nameof(aSNResponseAsn.AsnName), "Property is required for class ASNResponseAsn.");

            if (aSNResponseAsn.TypeOption.IsSet && aSNResponseAsn.Type == null)
                throw new ArgumentNullException(nameof(aSNResponseAsn.Type), "Property is required for class ASNResponseAsn.");

            if (aSNResponseAsn.DomainOption.IsSet && aSNResponseAsn.Domain == null)
                throw new ArgumentNullException(nameof(aSNResponseAsn.Domain), "Property is required for class ASNResponseAsn.");

            if (aSNResponseAsn.AllocationStatusOption.IsSet && aSNResponseAsn.AllocationStatus == null)
                throw new ArgumentNullException(nameof(aSNResponseAsn.AllocationStatus), "Property is required for class ASNResponseAsn.");

            if (aSNResponseAsn.RirOption.IsSet && aSNResponseAsn.Rir == null)
                throw new ArgumentNullException(nameof(aSNResponseAsn.Rir), "Property is required for class ASNResponseAsn.");

            if (aSNResponseAsn.RoutesOption.IsSet && aSNResponseAsn.Routes == null)
                throw new ArgumentNullException(nameof(aSNResponseAsn.Routes), "Property is required for class ASNResponseAsn.");

            if (aSNResponseAsn.UpstreamsOption.IsSet && aSNResponseAsn.Upstreams == null)
                throw new ArgumentNullException(nameof(aSNResponseAsn.Upstreams), "Property is required for class ASNResponseAsn.");

            if (aSNResponseAsn.DownstreamsOption.IsSet && aSNResponseAsn.Downstreams == null)
                throw new ArgumentNullException(nameof(aSNResponseAsn.Downstreams), "Property is required for class ASNResponseAsn.");

            if (aSNResponseAsn.PeersOption.IsSet && aSNResponseAsn.Peers == null)
                throw new ArgumentNullException(nameof(aSNResponseAsn.Peers), "Property is required for class ASNResponseAsn.");

            if (aSNResponseAsn.WhoisResponseOption.IsSet && aSNResponseAsn.WhoisResponse == null)
                throw new ArgumentNullException(nameof(aSNResponseAsn.WhoisResponse), "Property is required for class ASNResponseAsn.");

            if (aSNResponseAsn.AsNumberOption.IsSet)
                writer.WriteString("as_number", aSNResponseAsn.AsNumber);

            if (aSNResponseAsn.OrganizationOption.IsSet)
                writer.WriteString("organization", aSNResponseAsn.Organization);

            if (aSNResponseAsn.CountryOption.IsSet)
                writer.WriteString("country", aSNResponseAsn.Country);

            if (aSNResponseAsn.AsnNameOption.IsSet)
                writer.WriteString("asn_name", aSNResponseAsn.AsnName);

            if (aSNResponseAsn.TypeOption.IsSet)
                writer.WriteString("type", aSNResponseAsn.Type);

            if (aSNResponseAsn.DomainOption.IsSet)
                writer.WriteString("domain", aSNResponseAsn.Domain);

            if (aSNResponseAsn.DateAllocatedOption.IsSet)
                writer.WriteString("date_allocated", aSNResponseAsn.DateAllocated);

            if (aSNResponseAsn.AllocationStatusOption.IsSet)
                writer.WriteString("allocation_status", aSNResponseAsn.AllocationStatus);

            if (aSNResponseAsn.NumOfIpv4RoutesOption.IsSet)
                writer.WriteString("num_of_ipv4_routes", aSNResponseAsn.NumOfIpv4Routes);

            if (aSNResponseAsn.NumOfIpv6RoutesOption.IsSet)
                writer.WriteString("num_of_ipv6_routes", aSNResponseAsn.NumOfIpv6Routes);

            if (aSNResponseAsn.RirOption.IsSet)
                writer.WriteString("rir", aSNResponseAsn.Rir);

            if (aSNResponseAsn.RoutesOption.IsSet)
            {
                writer.WritePropertyName("routes");
                JsonSerializer.Serialize(writer, aSNResponseAsn.Routes, jsonSerializerOptions);
            }
            if (aSNResponseAsn.UpstreamsOption.IsSet)
            {
                writer.WritePropertyName("upstreams");
                JsonSerializer.Serialize(writer, aSNResponseAsn.Upstreams, jsonSerializerOptions);
            }
            if (aSNResponseAsn.DownstreamsOption.IsSet)
            {
                writer.WritePropertyName("downstreams");
                JsonSerializer.Serialize(writer, aSNResponseAsn.Downstreams, jsonSerializerOptions);
            }
            if (aSNResponseAsn.PeersOption.IsSet)
            {
                writer.WritePropertyName("peers");
                JsonSerializer.Serialize(writer, aSNResponseAsn.Peers, jsonSerializerOptions);
            }
            if (aSNResponseAsn.WhoisResponseOption.IsSet)
                writer.WriteString("whois_response", aSNResponseAsn.WhoisResponse);
        }
    }
}
